...
- secrets safety: `evidence_fetch` must refuse obvious secret assignments even in non-secret files (e.g., compose YAML), with an explicit escape hatch via `cat allow_secrets=true`.
