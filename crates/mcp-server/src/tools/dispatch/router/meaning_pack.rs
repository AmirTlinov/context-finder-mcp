...
pub(in crate::tools::dispatch) async fn meaning_pack(
    ...
    let output_format = request
        .output_format
        .unwrap_or(MeaningPackOutputFormat::Context);
    let want_context = matches!(
        output_format,
        MeaningPackOutputFormat::Context | MeaningPackOutputFormat::ContextAndDiagram
    );
    let want_diagram = matches!(
        output_format,
        MeaningPackOutputFormat::Diagram | MeaningPackOutputFormat::ContextAndDiagram
    );
